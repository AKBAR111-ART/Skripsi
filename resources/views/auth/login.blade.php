            ...
            <div class="glass-card p-8 md:p-10">
                ...
                <form method="POST" action="{{ url('/login') }}" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ url('/forgot-password') }}" class="text-sm text-teal-600 hover:text-teal-700 font-medium">Lupa password?</a>
                    </div>
                ...
                <div class="mt-4 text-center">
                    <p class="text-gray-600 text-sm">
                        Belum punya akun?
                        <a href="{{ url('/register') }}" class="text-teal-600 font-semibold hover:text-teal-700 hover:underline">
                            Daftar Sekarang
                        </a>
                    </p>
                </div>
