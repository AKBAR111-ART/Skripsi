...
<body class="bg-gradient-to-br from-teal-700 to-teal-500 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        ...
        <div class="text-center mt-6">
            <a href="<?php echo e(url('/login')); ?>" class="text-teal-600 hover:text-teal-700 text-sm">
                <i class="fas fa-arrow-left mr-1"></i> Kembali ke Login
            </a>
        </div>
    </div>
</body>
</html><?php /**PATH C:\xampp\htdocs\Skirpsi\tambak_udang\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>