...
<head>
    ...
    <style>
        * { font-family: 'Inter', sans-serif; }
        body {
            background: url('<?php echo e(asset('images/udang.png')); ?>') no-repeat center center fixed;
            ...
            <div class="bg-gradient-to-br from-teal-800 to-teal-600 p-8 md:p-10 flex flex-col justify-between">
                <div>
                    <div class="flex items-center space-x-3 mb-8">
                        <img src="<?php echo e(asset('images/logo-udang.png')); ?>" class="h-12 w-12 object-contain" alt="Logo">
                        <span class="text-white text-2xl font-bold">Tambak Mandhala</span>
                    </div>
                    <h1 class="text-white text-3xl md:text-4xl font-bold mb-4">
                        Sistem Rekomendasi<br>Pakan Udang
                    </h1>
            ...
            <div class="glass-card p-8 md:p-10">
                ...
                <form method="POST" action="<?php echo e(url('/login')); ?>" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <button type="button" onclick="togglePassword()" class="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="<?php echo e(url('/forgot-password')); ?>" class="text-sm text-teal-600 hover:text-teal-700 font-medium">Lupa password?</a>
                    </div>
                ...
                <div class="mt-4 text-center">
                    <p class="text-gray-600 text-sm">
                        Belum punya akun?
                        <a href="<?php echo e(url('/register')); ?>" class="text-teal-600 font-semibold hover:text-teal-700 hover:underline">
                            Daftar Sekarang
                        </a>
                    </p>
                </div>
                ...
                <div class="mt-6 pt-4 border-t border-gray-200 text-center">
                    <p class="text-xs text-gray-500"><i class="fas fa-shield-alt mr-1"></i> Sistem aman untuk data tambak Anda</p>
                    <p class="text-xs text-gray-400 mt-2">Butuh bantuan? Hubungi <span class="text-teal-600 font-medium">0811-2233-4455</span></p>
                </div>
            </div>
        </div>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\Skirpsi\tambak_udang\resources\views/auth/login.blade.php ENDPATH**/ ?>