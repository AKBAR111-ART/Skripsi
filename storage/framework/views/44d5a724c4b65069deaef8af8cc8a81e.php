            ...
            <div class="glass-card p-8 md:p-10">
                ...
                <?php if($errors->any()): ?>
                    <div class="mb-4 p-3 rounded-xl bg-red-50 border border-red-200 text-red-700 text-sm">
                        <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center"><i class="fas fa-times-circle mr-2"></i> <?php echo e($error); ?></div>
                ...
                <form method="POST" action="<?php echo e(url('/login')); ?>" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="<?php echo e(url('/forgot-password')); ?>" class="text-sm text-teal-600 hover:text-teal-700 font-medium">
                            Lupa password?
                        </a>
                    </div>
